...
{
    /// <summary>
    /// Controller class for dashCommerce_Store_Image
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class ImageController
    {
        // Preload our schema..
        Image thisSchemaLoad = new Image();
        ...
        {
            return (Image.Delete(ImageId) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object ImageId)
        {
            return (Image.Destroy(ImageId) == 1);
        }
	    ...
	    public void Update(int ImageId,int ProductId,string ImageFile,int SortOrder,string Caption,string CreatedBy,DateTime CreatedOn,string ModifiedBy,DateTime ModifiedOn)
	    {
		    Image item = new Image();
