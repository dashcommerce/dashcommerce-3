...
{
	/// <summary>
	/// Strongly-typed collection for the OrderStatusDescriptor class.
	/// </summary>
	[Serializable]
	public partial class OrderStatusDescriptorCollection : ActiveList<OrderStatusDescriptor, OrderStatusDescriptorCollection> 
	{	   
		public OrderStatusDescriptorCollection() {}

	}

	/// <summary>
	/// This is an ActiveRecord class which wraps the dashCommerce_Store_OrderStatusDescriptor table.
	/// </summary>
	[Serializable]
	public partial class OrderStatusDescriptor : ActiveRecord<OrderStatusDescriptor>
	{
		...
		public OrderStatusDescriptor(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public OrderStatusDescriptor(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public OrderStatusDescriptor(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		public MettleSystems.dashCommerce.Store.OrderCollection OrderRecords()
		{
			return new MettleSystems.dashCommerce.Store.OrderCollection().Where(Order.Columns.OrderStatusDescriptorId, OrderStatusDescriptorId).Load();
		}
		...
		/// </summary>
		public static void Insert(int varOrderStatusDescriptorId,string varName,string varCreatedBy,DateTime varCreatedOn,string varModifiedBy,DateTime varModifiedOn)
		{
			OrderStatusDescriptor item = new OrderStatusDescriptor();
		...
		/// </summary>
		public static void Update(int varOrderStatusDescriptorId,string varName,string varCreatedBy,DateTime varCreatedOn,string varModifiedBy,DateTime varModifiedOn)
		{
			OrderStatusDescriptor item = new OrderStatusDescriptor();
