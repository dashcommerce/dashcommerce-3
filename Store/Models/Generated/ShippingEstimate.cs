...
{
	/// <summary>
	/// Strongly-typed collection for the ShippingEstimate class.
	/// </summary>
	[Serializable]
	public partial class ShippingEstimateCollection : ActiveList<ShippingEstimate, ShippingEstimateCollection> 
	{	   
		public ShippingEstimateCollection() {}

	}

	/// <summary>
	/// This is an ActiveRecord class which wraps the dashCommerce_Store_ShippingEstimate table.
	/// </summary>
	[Serializable]
	public partial class ShippingEstimate : ActiveRecord<ShippingEstimate>
	{
		...
		public ShippingEstimate(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ShippingEstimate(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ShippingEstimate(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		{
			return new MettleSystems.dashCommerce.Store.ProductCollection().Where(Product.Columns.ShippingEstimateId, ShippingEstimateId).Load();
		}
		...
		/// </summary>
		public static void Update(int varShippingEstimateId,string varName,string varCreatedBy,DateTime varCreatedOn,string varModifiedBy,DateTime varModifiedOn)
		{
			ShippingEstimate item = new ShippingEstimate();
