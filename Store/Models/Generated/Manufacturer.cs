...
{
	/// <summary>
	/// Strongly-typed collection for the Manufacturer class.
	/// </summary>
	[Serializable]
	public partial class ManufacturerCollection : ActiveList<Manufacturer, ManufacturerCollection> 
	{	   
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the dashCommerce_Store_Manufacturer table.
	/// </summary>
	[Serializable]
	public partial class Manufacturer : ActiveRecord<Manufacturer>
	{
		...
		public Manufacturer(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Manufacturer(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public Manufacturer(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("dashCommerce_Store_Manufacturer", TableType.Table, DataService.GetInstance("dashCommerceProvider"));
				...
				colvarManufacturerId.AutoIncrement = true;
				...
				DataService.Providers["dashCommerceProvider"].AddSchema("dashCommerce_Store_Manufacturer",schema);
			}
		...
		{
			return new MettleSystems.dashCommerce.Store.ProductCollection().Where(Product.Columns.ManufacturerId, ManufacturerId).Load();
		}
		...
		/// </summary>
		public static void Update(int varManufacturerId,string varName,string varCreatedBy,DateTime varCreatedOn,string varModifiedBy,DateTime varModifiedOn)
		{
			Manufacturer item = new Manufacturer();
