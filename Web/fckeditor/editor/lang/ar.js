...
InsertLineLbl		: "�ط فاصل",
InsertLine			: "إدراج �ط فاصل",
...
InsertCellAfter		: "إدراج �لية بعد",
InsertCellBefore	: "إدراج �لية قبل",
DeleteCells			: "حذف �لايا",
MergeCells			: "دمج �لايا",
MergeRight			: "دمج لليمين",
MergeDown			: "دمج للأسفل",
HorizontalSplitCell	: "تقسيم ال�لية أفقياً",
VerticalSplitCell	: "تقسيم ال�لية عمودياً",
TableDelete			: "حذف الجدول",
CellProperties		: "�صائص ال�لية",
TableProperties		: "�صائص الجدول",
ImageProperties		: "�صائص الصورة",
FlashProperties		: "�صائص فيلم الفلاش",

AnchorProp			: "�صائص الإشارة المرجعية",
ButtonProp			: "�صائص زر الضغط",
CheckboxProp		: "�صائص �انة الإ�تيار",
HiddenFieldProp		: "�صائص الحقل ال�في",
RadioButtonProp		: "�صائص زر ال�يار",
ImageButtonProp		: "�صائص زر الصورة",
TextFieldProp		: "�صائص مربع النص",
SelectionFieldProp	: "�صائص القائمة المنسدلة",
TextareaProp		: "�صائص ناحية النص",
FormProp			: "�صائص النموذج",
...
Done				: "تم",
PasteWordConfirm	: "يبدو أن النص المراد لصقه منسو� من برنامج وورد. هل تود تنظيفه قبل الشروع في عملية اللصق؟",
...
NoActiveX			: "لتأمين متصفحك يجب أن تحدد بعض مميزات المحرر. يتوجب عليك تمكين ال�يار \"Run ActiveX controls and plug-ins\". قد تواجة أ�طاء وتلاحظ مميزات مفقودة",
...
DlgBtnClose			: "إغلاق",
DlgBtnBrowseServer	: "تصفح ال�ادم",
...
DlgGenAccessKey		: "مفاتيح الإ�تصار",
DlgGenName			: "الاسم",
...
// Image Dialog
DlgImgTitle			: "�صائص الصورة",
DlgImgInfoTab		: "معلومات الصورة",
DlgImgBtnUpload		: "أرسلها لل�ادم",
...
// Flash Dialog
DlgFlashTitle		: "�صائص فيلم الفلاش",
...
DlgLnkProtoOther	: "<أ�رى>",
DlgLnkURL			: "الموقع",
DlgLnkAnchorSel		: "ا�تر علامة مرجعية",
...
DlgLnkPopWinFeat	: "�صائص النافذة المنبثقة",
...
DlnLnkMsgNoUrl		: "فضلاً أد�ل عنوان الموقع الذي يشير إليه الرابط",
DlnLnkMsgNoEMail	: "فضلاً أد�ل عنوان البريد الإلكتروني",
...
// Color Dialog
DlgColorTitle		: "ا�تر لوناً",
DlgColorBtnClear	: "مسح",
DlgColorHighlight	: "تحديد",
DlgColorSelected	: "إ�تيار",
...
DlgTableCellSpace	: "تباعد ال�لايا",
DlgTableCellPad		: "المسافة البادئة",
DlgTableCaption		: "الوصف",
DlgTableSummary		: "ال�لاصة",

// Table Cell Dialog
DlgCellTitle		: "�صائص ال�لية",
DlgCellWidth		: "العرض",
DlgCellWidthPx		: "بكسل",
...
PasteErrorCut	: "الإعدادات الأمنية للمتصفح الذي تست�دمه تمنع القص التلقائي. فضلاً إست�دم لوحة المفاتيح لفعل ذلك (Ctrl+X).",
PasteErrorCopy	: "الإعدادات الأمنية للمتصفح الذي تست�دمه تمنع النس� التلقائي. فضلاً إست�دم لوحة المفاتيح لفعل ذلك (Ctrl+C).",

PasteAsText		: "لصق كنص بسيط",
PasteFromWord	: "لصق من وورد",

DlgPasteMsg2	: "الصق دا�ل الصندوق بإست�دام زرّي (<STRONG>Ctrl+V</STRONG>) في لوحة المفاتيح، ثم اضغط زر  <STRONG>موافق</STRONG>.",
DlgPasteSec		: "نظراً لإعدادات الأمان ال�اصة بمتصفحك، لن يتمكن هذا المحرر من الوصول لمحتوى حافظتك، لذا وجب عليك لصق المحتوى مرة أ�رى في هذه النافذة.",
DlgPasteIgnoreFont		: "تجاهل تعريفات أسماء ال�طوط",
...
// Document Properties
DocProps		: "�صائص الصفحة",

// Anchor Dialog
DlgAnchorTitle		: "�صائص إشارة مرجعية",
...
DlgSpellNoMispell		: "تم إكمال التدقيق الإملائي: لم يتم العثور على أي أ�طاء إملائية",
...
DlgSelectOpAvail	: "ال�يارات المتاحة",
...
BulletedListProp	: "�صائص التعداد النقطي",
NumberedListProp	: "�صائص التعداد الرقمي",
...
DlgDocCharSetOther	: "ترميز آ�ر",

DlgDocDocType		: "ترويسة نوع  الصفحة",
DlgDocDocTypeOther	: "ترويسة نوع  صفحة أ�رى",
DlgDocIncXHTML		: "تضمين   إعلانات‏ لغة XHTMLَ",
DlgDocBgColor		: "لون ال�لفية",
DlgDocBgImage		: "رابط الصورة ال�لفية",
...
DlgTemplatesSelMsg	: "ا�تر القالب الذي تود وضعه في المحرر <br>(سيتم فقدان المحتوى الحالي):",
