...
InsertLineLbl		: "水平線",
InsertLine			: "插入水平線",
InsertSpecialCharLbl: "特�符號",
InsertSpecialChar	: "插入特�符號",
...
Redo				: "重複",
NumberedListLbl		: "編號清�",
NumberedList		: "插入/移除編號清�",
BulletedListLbl		: "項�清�",
BulletedList		: "插入/移除項�清�",
...
UnknownToolbarItem	: "未知工具列項� \"%1\"",
UnknownCommand		: "未知指令名稱 \"%1\"",
NotImplemented		: "尚未�裝此指令",
UnknownToolbarSet	: "工具列設� \"%1\" 不存在",
NoActiveX			: "瀏覽器的�全性設�限制了本編輯器的某些功能。您必須啟用�全性設�中的「執行ActiveX控制項與外掛程式」項�，否則本編輯器將會出現錯誤並缺少某些功能",
BrowseServerBlocked : "無法開啟資源瀏覽器，請確�所有快顯視窗封鎖程式是否關閉",
DialogBlocked		: "無法開啟對話視窗，請確�所有快顯視窗封鎖程式是否關閉",
...
PasteErrorCut	: "瀏覽器的�全性設�不允許編輯器自動執行剪下動作。請使用快捷鍵 (Ctrl+X) 剪下。",
PasteErrorCopy	: "瀏覽器的�全性設�不允許編輯器自動執行複製動作。請使用快捷鍵 (Ctrl+C) 複製。",

PasteAsText		: "貼為純文字格式",
PasteFromWord	: "自 Word 貼上",

DlgPasteMsg2	: "請使用快捷鍵 (<strong>Ctrl+V</strong>) 貼到下方區域中並按下 <strong>確�</strong>",
DlgPasteSec		: "因為瀏覽器的�全性設�，本編輯器無法直接存取您的剪貼簿資料，請您自行在本視窗進行貼上動作。",
DlgPasteIgnoreFont		: "移除字型設�",
DlgPasteRemoveStyles	: "移除樣式設�",
...
DlgSpellNoMispell		: "拼字檢查�成：未發現拼字錯誤",
DlgSpellNoChanges		: "拼字檢查�成：未更改任何�字",
DlgSpellOneChange		: "拼字檢查�成：更改了 1 個�字",
DlgSpellManyChanges		: "拼字檢查�成：更改了 %1 個�字",

IeSpellDownload			: "尚未�裝拼字檢查元件。您是否想要現在下載？",
...
BulletedListProp	: "項�清�屬性",
NumberedListProp	: "編號清�屬性",
DlgLstStart			: "起始編號",
DlgLstType			: "清�類型",
DlgLstTypeCircle	: "圓圈",
DlgLstTypeDisc		: "圓點",
...
// Templates Dialog
Templates			: "樣版",
DlgTemplatesTitle	: "內�樣版",
DlgTemplatesSelMsg	: "請選擇欲開啟的樣版<br> (原有的內�將會被清除):",
DlgTemplatesLoading	: "�取樣版清�中，請稍候…",
DlgTemplatesNoTpl	: "(無樣版)",
DlgTemplatesReplace	: "取代原有內�",
