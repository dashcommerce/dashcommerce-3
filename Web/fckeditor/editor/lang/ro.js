...
InsertRowBefore		: "Inserează linie �nainte",
DeleteRows			: "Şterge linii",
InsertColumnAfter	: "Inserează coloană după",
InsertColumnBefore	: "Inserează coloană �nainte",
DeleteColumns		: "Şterge celule",
InsertCellAfter		: "Inserează celulă după",
InsertCellBefore	: "Inserează celulă �nainte",
...
Done				: "Am terminat",
PasteWordConfirm	: "Textul pe care doriţi să-l adăugaţi pare a fi formatat pentru Word. Doriţi să-l curăţaţi de această formatare �nainte de a-l adăuga?",
NotCompatiblePaste	: "Această facilitate e disponibilă doar pentru Microsoft Internet Explorer, versiunea 5.5 sau ulterioară. Vreţi să-l adăugaţi fără a-i fi �nlăturat formatarea?",
...
NoActiveX			: "Setările de securitate ale programului dvs. cu care navigaţi pe internet (browser) pot limita anumite funcţionalităţi ale editorului. Pentru a evita asta, trebuie să activaţi opţiunea \"Run ActiveX controls and plug-ins\". Poate veţi �ntâlni erori sau veţi observa funcţionalităţi lipsă.",
...
DlgLnkTypeURL		: "URL",
DlgLnkTypeAnchor	: "Ancoră �n această pagină",
...
DlgLnkNoAnchors		: "(Nicio ancoră disponibilă �n document)",
...
DlnLnkMsgInvPopName	: "Numele 'popup'-ului trebuie să �nceapă cu un caracter alfabetic şi trebuie să nu conţină spaţii",
...
DlgTableCellSpace	: "Spaţiu �ntre celule",
DlgTableCellPad		: "Spaţiu �n cadrul celulei",
...
DlgFindAndReplaceTitle	: "Găseşte şi �nlocuieşte",
...
PasteErrorCut	: "Setările de securitate ale navigatorului (browser) pe care �l folosiţi nu permit editorului să execute automat operaţiunea de tăiere. Vă rugăm folosiţi tastatura (Ctrl+X).",
PasteErrorCopy	: "Setările de securitate ale navigatorului (browser) pe care �l folosiţi nu permit editorului să execute automat operaţiunea de copiere. Vă rugăm folosiţi tastatura (Ctrl+C).",

PasteAsText		: "Adaugă ca text simplu (Plain Text)",
PasteFromWord	: "Adaugă din Word",

DlgPasteMsg2	: "Vă rugăm adăugaţi �n căsuţa următoare folosind tastatura (<STRONG>Ctrl+V</STRONG>) şi apăsaţi <STRONG>OK</STRONG>.",
DlgPasteSec		: "Din cauza setărilor de securitate ale programului dvs. cu care navigaţi pe internet (browser), editorul nu poate accesa direct datele din clipboard. Va trebui să adăugaţi din nou datele �n această fereastră.",
...
DlgSpellNotInDic		: "Nu e �n dicţionar",
DlgSpellChangeTo		: "Schimbă �n",
...
DlgSpellProgress		: "Verificarea textului �n desfăşurare...",
...
DlgTemplatesSelMsg	: "Vă rugăm selectaţi template-ul (şablonul) ce se va deschide �n editor<br>(conţinutul actual va fi pierdut):",
DlgTemplatesLoading	: "Se �ncarcă lista cu template-uri (şabloane). Vă rugăm aşteptaţi...",
