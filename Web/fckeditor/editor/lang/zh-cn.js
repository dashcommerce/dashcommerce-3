...
InsertLineLbl		: "水平线",
InsertLine			: "插入水平线",
InsertSpecialCharLbl: "特�符号",
InsertSpecialChar	: "插入特�符号",
InsertSmileyLbl		: "表情符",
InsertSmiley		: "插入表情图标",
About				: "关于 FCKeditor",
Bold				: "加粗",
...
BulletedListLbl		: "项�列表",
BulletedList		: "插入/删除项�列表",
...
FontFormats			: "�通;已编排格式;地址;标题 1;标题 2;标题 3;标题 4;标题 5;标题 6;�落(DIV)",

// Alerts and Messages
ProcessingXHTML		: "正在处理 XHTML，请稍等...",
Done				: "�成",
PasteWordConfirm	: "您要粘贴的内�好像是来自 MS Word，是否要清除 MS Word 格式后再粘贴？",
NotCompatiblePaste	: "该命令需要 Internet Explorer 5.5 或更高版本的支持，是否按常规粘贴进行？",
UnknownToolbarItem	: "未知工具栏项� \"%1\"",
UnknownCommand		: "未知命令名称 \"%1\"",
NotImplemented		: "命令无法执行",
UnknownToolbarSet	: "工具栏�� \"%1\" 不存在",
NoActiveX			: "浏览器�全��限制了本编辑器的某些功能。您必须启用�全��中的“运行 ActiveX 控件和插件”，否则将出现某些错误并缺少功能。",
BrowseServerBlocked : "无法打开资源浏览器，请��是否启用了禁止弹出窗口。",
DialogBlocked		: "无法打开对话框窗口，请��是否启用了禁止弹出窗口或网页对话框（IE）。",
...
PasteErrorCut	: "您的浏览器�全��不允�编辑器自动执行剪切操作，请使用�盘快捷�(Ctrl+X)来�成。",
PasteErrorCopy	: "您的浏览器�全��不允�编辑器自动执行复制操作，请使用�盘快捷�(Ctrl+C)来�成。",

PasteAsText		: "粘贴为无格式文本",
PasteFromWord	: "从 MS Word 粘贴",

DlgPasteMsg2	: "请使用�盘快捷�(<STRONG>Ctrl+V</STRONG>)把内�粘贴到下面的方框里，再按 <STRONG>��</STRONG>。",
DlgPasteSec		: "因为你的浏览器的�全��原因，本编辑器不能直接��你的剪贴板内�，你需要在本窗口重新粘贴一次。",
DlgPasteIgnoreFont		: "忽略 Font 标签",
DlgPasteRemoveStyles	: "清理 CSS 样式",
DlgPasteCleanBox		: "清空上面内�",

// Color Picker
ColorAutomatic	: "自动",
ColorMoreColors	: "其�颜色...",
...
DlgSpellBtnUndo			: "撤消",
DlgSpellNoSuggestions	: "- 没有建� -",
DlgSpellProgress		: "正在进行拼写检查...",
DlgSpellNoMispell		: "拼写检查�成：没有发现拼写错误",
DlgSpellNoChanges		: "拼写检查�成：没有更改任何单词",
DlgSpellOneChange		: "拼写检查�成：更改了一个单词",
DlgSpellManyChanges		: "拼写检查�成：更改了 %1 个单词",

IeSpellDownload			: "拼写检查插件还没�装，你是否想现在就下载？",
...
DlgSelectBtnUp		: "上移",
DlgSelectBtnDown	: "下移",
DlgSelectBtnSetValue : "�为初始化时选�",
DlgSelectBtnDelete	: "删除",

// Textarea Dialog
DlgTextareaName	: "名称",
DlgTextareaCols	: "字符�度",
DlgTextareaRows	: "行数",

// Text Field Dialog
DlgTextName			: "名称",
DlgTextValue		: "初始值",
DlgTextCharWidth	: "字符�度",
...
DlgDocCharSetWE		: "西欧",
DlgDocCharSetOther	: "其�字符编码",

DlgDocDocType		: "文档类型",
DlgDocDocTypeOther	: "其�文档类型",
...
DlgDocMaRight		: "右",
DlgDocMaBottom		: "下",
DlgDocMeIndex		: "页面索引关�字 (用半角逗号[,]分隔)",
DlgDocMeDescr		: "页面说明",
DlgDocMeAuthor		: "作者",
DlgDocMeCopy		: "版权",
DlgDocPreview		: "预览",
...
// Templates Dialog
Templates			: "模板",
DlgTemplatesTitle	: "内�模板",
DlgTemplatesSelMsg	: "请选择编辑器内�模板<br>(当前内�将会被清除替换):",
DlgTemplatesLoading	: "正在加载模板列表，请稍等...",
DlgTemplatesNoTpl	: "(没有模板)",
DlgTemplatesReplace	: "替换当前内�",

// About Dialog
DlgAboutAboutTab	: "关于",
DlgAboutBrowserInfoTab	: "浏览器信息",
DlgAboutLicenseTab	: "�可证",
DlgAboutVersion		: "版本",
DlgAboutInfo		: "要获得更多信息请�� "
};
