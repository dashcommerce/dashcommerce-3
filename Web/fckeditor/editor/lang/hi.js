...
ToolbarCollapse		: "टूलबार सि�टायें",
...
InsertSmileyLbl		: "स्�ाइली",
InsertSmiley		: "स्�ाइली इन्सर्ट करें",
About				: "FCKeditor के बारे �ें",
Bold				: "बोल्ड",
Italic				: "इटैलिक",
Underline			: "रेखांकण",
...
CenterJustify		: "बीच �ें",
RightJustify		: "दायीं तरफ",
BlockJustify		: "ब्लॉक जस्टीफ़ाई",
DecreaseIndent		: "इन्डॅन्ट क� करें",
...
FitWindow		: "एडिटर साइज़ को चर� सी�ा तक बढ़ायें",
...
RowCM				: "पंक्ति",
ColumnCM			: "काल�",
InsertRowAfter		: "बाद �ें पंक्ति डालें",
InsertRowBefore		: "पहले पंक्ति डालें",
DeleteRows			: "पंक्तियाँ डिलीट करें",
InsertColumnAfter	: "बाद �ें काल� डालें",
InsertColumnBefore	: "पहले काल� डालें",
DeleteColumns		: "काल� डिलीट करें",
InsertCellAfter		: "बाद �ें सैल डालें",
InsertCellBefore	: "पहले सैल डालें",
DeleteCells			: "सैल डिलीट करें",
MergeCells			: "सैल �िलायें",
MergeRight			: "बाँया विलय",
MergeDown			: "नीचे विलय करें",
HorizontalSplitCell	: "सैल को क्षैतिज स्थिति �ें विभाजित करें",
VerticalSplitCell	: "सैल को ल�्बाकार �ें विभाजित करें",
...
FormProp			: "फ़ॉर्� प्रॉपर्टीज़",

FontFormats			: "साधारण;फ़ॉर्�ैटॅड;पता;शीर्षक 1;शीर्षक 2;शीर्षक 3;शीर्षक 4;शीर्षक 5;शीर्षक 6;शीर्षक (DIV)",
...
NotCompatiblePaste	: "यह क�ांड इन्टरनॅट एक्स्प्लोरर(Internet Explorer) 5.5 या उसके बाद के वर्ज़न के लिए ही उपलब्ध है। क्या आप बिना साफ़ किए पेस्ट करना चाहेंगे?",
UnknownToolbarItem	: "अनजान टूलबार आइट� \"%1\"",
UnknownCommand		: "अनजान क�ान्ड \"%1\"",
NotImplemented		: "क�ान्ड इ�्प्ली�ॅन्ट नहीं किया गया है",
UnknownToolbarSet	: "टूलबार सॅट \"%1\" उपलब्ध नहीं है",
NoActiveX			: "आपके ब्राउज़र् की सुरक्शा सेटिंग्स् एडिटर की कुछ् फ़ीचरों को सी�ित कर् सकती हैं। क्रिपया \"Run ActiveX controls and plug-ins\" विकल्प को एनेबल करें. आपको एरर्स् और गायब फ़ीचर्स् का अनुभव हो सकता है।",
...
DlgGenTitle			: "परा�र्श शीर्शक",
DlgGenContType		: "परा�र्श कन्टॅन्ट प्रकार",
...
DlgImgAlignBaseline	: "�ूल रेखा",
DlgImgAlignBottom	: "नीचे",
DlgImgAlignMiddle	: "�ध्य",
...
DlgFlashChkLoop		: "लूप",
DlgFlashChkMenu		: "फ़्लैश �ॅन्यू का प्रयोग करें",
DlgFlashScale		: "स्केल",
...
DlgLnkTypeEMail		: "ई-�ेल",
DlgLnkProto			: "प्रोटोकॉल",
DlgLnkProtoOther	: "<अन्य>",
DlgLnkURL			: "URL",
DlgLnkAnchorSel		: "ऐंकर चुनें",
DlgLnkAnchorByName	: "ऐंकर ना� से",
DlgLnkAnchorById	: "ऍली�ॅन्ट Id से",
DlgLnkNoAnchors		: "(डॉक्यू�ॅन्ट �ें ऐंकर्स की संख्या)",
DlgLnkEMail			: "ई-�ेल पता",
...
DlnLnkMsgNoEMail	: "ई-�ेल पता टाइप करें",
DlnLnkMsgNoAnchor	: "ऐंकर चुनें",
DlnLnkMsgInvPopName	: "पॉप-अप का ना� अल्फाबेट से शुरू होना चाहिये और उस�ें स्पेस नहीं होने चाहिए",
...
// Smiley Dialog
DlgSmileyTitle		: "स्�ाइली इन्सर्ट करें",
...
DlgTableAlign		: "ऍलाइन्�ॅन्ट",
DlgTableAlignNotSet	: "<सॅट नहीं>",
DlgTableAlignLeft	: "दायें",
DlgTableAlignCenter	: "बीच �ें",
...
DlgFindNotFoundMsg	: "आपके द्वारा दिया गया टेक्स्ट नहीं �िला",

// Replace Dialog
DlgReplaceTitle			: "रिप्लेस",
DlgReplaceFindLbl		: "यह खोजें:",
DlgReplaceReplaceLbl	: "इससे रिप्लेस करें:",
DlgReplaceCaseChk		: "केस �िलायें",
DlgReplaceReplaceBtn	: "रिप्लेस",
DlgReplaceReplAllBtn	: "सभी रिप्लेस करें",
DlgReplaceWordChk		: "पूरा शब्द �िलायें",

// Paste Operations / Dialog
PasteErrorCut	: "आपके ब्राउज़र की सुरक्षा सॅटिन्ग्स ने कट करने की अनु�ति नहीं प्रदान की है। (Ctrl+X) का प्रयोग करें।",
PasteErrorCopy	: "आपके ब्राआउज़र की सुरक्षा सॅटिन्ग्स ने कॉपी करने की अनु�ति नहीं प्रदान की है। (Ctrl+C) का प्रयोग करें।",

PasteAsText		: "पेस्ट (सादा टॅक्स्ट)",
PasteFromWord	: "पेस्ट (वर्ड से)",

DlgPasteMsg2	: "Ctrl+V का प्रयोग करके पेस्ट करें और ठीक है करें.",
DlgPasteSec		: "आपके ब्राउज़र की सुरक्षा आपके ब्राउज़र की सुरKश सैटिंग के कारण, एडिटर आपके क्लिपबोर्ड डेटा को नहीं पा सकता है. आपको उसे इस विन्डो �ें दोबारा पेस्ट करना होगा.",
...
// Document Properties
DocProps		: "डॉक्यू�ॅन्ट प्रॉपर्टीज़",

// Anchor Dialog
DlgAnchorTitle		: "ऐंकर प्रॉपर्टीज़",
DlgAnchorName		: "ऐंकर का ना�",
DlgAnchorErrorName	: "ऐंकर का ना� टाइप करें",

// Speller Pages Dialog
DlgSpellNotInDic		: "शब्दकोश �ें नहीं",
DlgSpellChangeTo		: "इस�ें बदलें",
...
DlgLstTypeSRoman	: "छोटे रो�न अंक (i, ii, iii)",
DlgLstTypeLRoman	: "बड़े रो�न अंक (I, II, III)",

// Document Properties Dialog
DlgDocGeneralTab	: "आ�",
DlgDocBackTab		: "बैक्ग्राउन्ड",
DlgDocColorsTab		: "रंग और �ार्जिन",
DlgDocMetaTab		: "�ॅटाडेटा",
...
DlgDocCharSetCE		: "�ध्य यूरोपीय (Central European)",
...
DlgDocCharSetWE		: "पश्चि� यूरोपीय (Western European)",
DlgDocCharSetOther	: "अन्य करेक्टर सॅट ऍन्कोडिंग",

DlgDocDocType		: "डॉक्यू�ॅन्ट प्रकार शीर्षक",
DlgDocDocTypeOther	: "अन्य डॉक्यू�ॅन्ट प्रकार शीर्षक",
DlgDocIncXHTML		: "XHTML सूचना स�्�िलित करें",
...
DlgDocMargins		: "पेज �ार्जिन",
DlgDocMaTop			: "ऊपर",
DlgDocMaLeft		: "बायें",
DlgDocMaRight		: "दायें",
DlgDocMaBottom		: "नीचे",
DlgDocMeIndex		: "डॉक्यु�ॅन्ट इन्डेक्स संकेतशब्द (अल्पविरा� से अलग करें)",
DlgDocMeDescr		: "डॉक्यू�ॅन्ट करॅक्टरन",
DlgDocMeAuthor		: "लेखक",
...
// Templates Dialog
Templates			: "टॅ�्प्लेट",
DlgTemplatesTitle	: "कन्टेन्ट टॅ�्प्लेट",
DlgTemplatesSelMsg	: "ऍडिटर �ें ओपन करने हेतु टॅ�्प्लेट चुनें(वर्त�ान कन्टॅन्ट सेव नहीं होंगे):",
DlgTemplatesLoading	: "टॅ�्प्लेट सूची लोड की जा रही है। ज़रा ठहरें...",
DlgTemplatesNoTpl	: "(कोई टॅ�्प्लेट डिफ़ाइन नहीं किया गया है)",
DlgTemplatesReplace	: "�ूल शब्दों को बदलें",

// About Dialog
DlgAboutAboutTab	: "FCKEditor के बारे �ें",
DlgAboutBrowserInfoTab	: "ब्राउज़र के बारे �ें",
