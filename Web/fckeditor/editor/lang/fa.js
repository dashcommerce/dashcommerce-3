...
InsertLineLbl		: "�ط",
InsertLine			: "گنجاندن �ط ِافقی",
InsertSpecialCharLbl: "نویسهٴ ویژه",
InsertSpecialChar	: "گنجاندن نویسهٴ ویژه",
InsertSmileyLbl		: "�ندانک",
InsertSmiley		: "گنجاندن �ندانک",
About				: "دربارهٴ FCKeditor",
Bold				: "درشت",
Italic				: "�میده",
Underline			: "�ط‌زیردار",
StrikeThrough		: "میان‌�ط",
Subscript			: "زیرنویس",
...
CheckboxProp		: "ویژگیهای �انهٴ گزینه‌ای",
...
Done				: "انجام شد",
PasteWordConfirm	: "متنی که می‌�واهید بچسبانید به نظر می‌رسد از Word کپی شده است. آیا می‌�واهید قبل از چسباندن آن را پاک‌سازی کنید؟",
NotCompatiblePaste	: "این فرمان برای مرورگر Internet Explorer از نگارش 5.5 یا بالاتر در دسترس است. آیا می‌�واهید بدون پاک‌سازی، متن را بچسبانید؟",
UnknownToolbarItem	: "فقرهٴ نوارابزار ناشنا�ته \"%1\"",
UnknownCommand		: "نام دستور ناشنا�ته \"%1\"",
NotImplemented		: "دستور پیاده‌سازی‌نشده",
UnknownToolbarSet	: "مجموعهٴ نوارابزار \"%1\" وجود ندارد",
NoActiveX			: "تنظیمات امنیتی مرورگر شما ممکن است در بعضی از ویژگیهای مرورگر محدودیت ایجاد کند. شما باید گزینهٴ \"Run ActiveX controls and plug-ins\" را فعال کنید. ممکن است شما با �طاهایی روبرو باشید و متوجه کمبود ویژگیهایی شوید.",
...
DlnLnkMsgInvPopName	: "نام پنجرهٴ پاپاپ باید با یک نویسهٴ الفبایی آغاز گردد و نباید فاصله‌های �الی در آن باشند",
...
DlgCellVerAlignBaseline	: "�ط‌پایه",
...
PasteErrorCut	: "تنظیمات امنیتی مرورگر شما اجازه نمی‌دهد که ویرایشگر به طور �ودکار عملکردهای برش را انجام دهد. لطفا با دکمه‌های صفحه‌کلید این کار را انجام دهید (Ctrl+X).",
PasteErrorCopy	: "تنظیمات امنیتی مرورگر شما اجازه نمی‌دهد که ویرایشگر به طور �ودکار عملکردهای کپی‌کردن را انجام دهد. لطفا با دکمه‌های صفحه‌کلید این کار را انجام دهید (Ctrl+C).",
...
DlgPasteSec		: "به �اطر تنظیمات امنیتی مرورگر شما، ویرایشگر نمی‌تواند دسترسی مستقیم به داده‌های clipboard داشته باشد. شما باید دوباره آنرا در این پنجره بچسبانید.",
...
IeSpellDownload			: "بررسی‌کنندهٴ املا نصب نشده است. آیا می‌�واهید آن را هم‌اکنون دریافت کنید؟",
...
DlgTemplatesSelMsg	: "لطفا الگوی موردنظر را برای بازکردن در ویرایشگر برگزینید<br>(محتویات کنونی از دست �واهند رفت):",
