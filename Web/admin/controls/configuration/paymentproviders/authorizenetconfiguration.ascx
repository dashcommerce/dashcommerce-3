...
<asp:Panel ID="pnlSettings" runat="server">
  ...
  <asp:TextBox ID="txtApiUserName" runat="server" CssClass="textbox" />&nbsp;<dashCommerce:HelpLink ID="helpApiUserName" runat="server" NavigateUrl="javascript:void(0);"><asp:Image ID="imgApiUserNameHelp" runat="server" SkinID="help" /></dashCommerce:HelpLink><br /><br />
  <asp:Label ID="lblApiTransactionKey" runat="server" CssClass="label" /><br />
  <asp:TextBox ID="txtApiTransactionKey" runat="server" CssClass="textbox" />&nbsp;<dashCommerce:HelpLink ID="helplApiTransactionKey" runat="server" NavigateUrl="javascript:void(0);"><asp:Image ID="Image1" runat="server" SkinID="help" /></dashCommerce:HelpLink><br /><br />
  <asp:Label ID="lblIsInTestMode" runat="server" CssClass="label" /><br />
  <asp:CheckBox ID="chkIsInTestMode" runat="server" />&nbsp;<dashCommerce:HelpLink ID="helpIsInTestMode" runat="server" NavigateUrl="javascript:void(0);"><asp:Image ID="Image2" runat="server" SkinID="help" /></dashCommerce:HelpLink><br /><br />
  <asp:Label ID="lblIsLive" runat="server" CssClass="label" /><br />
  <asp:CheckBox ID="chkIsLive" runat="server" />&nbsp;<dashCommerce:HelpLink ID="helpIsLive" runat="server" NavigateUrl="javascript:void(0);"><asp:Image ID="Image3" runat="server" SkinID="help" /></dashCommerce:HelpLink><br /><br />
